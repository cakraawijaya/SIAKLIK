<?php require_once __DIR__ . '/../features/token_check.php'; ?>
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content border-0 shadow-lg">
          ...
          <div class="modal-body pt-4 px-4">
            <form method="POST" action="<?= BASE_URL ?>components/features/reset_password.php">
          ...
          <div class="modal-footer text-center flex-column">
            <p class="mb-0 select-none">Sudah ingat password? 
              <a href="<?= BASE_URL ?>components/features/delete_reset_token.php?email=<?= urlencode($_GET['email'] ?? '') ?>">
