              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group form-status">
                    ...
                    <select name="status" class="form-control select-none" required>
                  ...
                  <div class="form-group form-layanan">
                      ...
                      <select name="layanan" class="form-control select-none" required>
          ...
          <form method="POST" id="formEditPasien" autocomplete="off">
            ...
            <div class="modal-footer mr-2">
              ...
              <button type="submit" name="submit_edit" class="btn btn-warning-custom text-white">
                <strong><i class="fa fa-edit mr-1" aria-hidden="true"></i>Update</strong>
              </button>
            </div>
          </form>
        </div>
