    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content border-0 shadow-lg">
        ...
        <div class="modal-body pt-4 px-4">
          <form action="<?= BASE_URL ?>components/features/registration_check.php" method="post">
            <div class="row">
              <!-- Kiri -->
              <div class="col-md-6">
                    ...
                    <div class="col-auto">
                      <div class="d-flex">
                        <img id="captchaRegistrationPasien" class="select-none"
                          data-base="<?= BASE_URL ?>components/features/captcha_generate.php?id=registrasi_pasien"
                          src="<?= BASE_URL ?>components/features/captcha_generate.php?id=registrasi_pasien&<?= time() ?>"
                          alt="Captcha"
                        >
