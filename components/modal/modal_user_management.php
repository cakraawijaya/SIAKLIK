                  ...
                  <div class="form-group form-verifikasi-captcha">
                    ...
                    <div class="d-flex align-items-center">
                      <img id="captchaAddPenggunaPasien" class="select-none"
                        data-base="<?= BASE_URL ?>components/features/captcha_generate.php?id=add_user_pasien"
                        src="<?= BASE_URL ?>components/features/captcha_generate.php?id=add_user_pasien&<?= time() ?>"
                        alt="Captcha">
                  ...
                  <div class="form-group form-verifikasi-captcha">
                    ...
                    <div class="d-flex align-items-center">
                      <img id="captchaEditPenggunaPasien" class="select-none"
                        data-base="<?= BASE_URL ?>components/features/captcha_generate.php?id=edit_user_pasien"
                        src="<?= BASE_URL ?>components/features/captcha_generate.php?id=edit_user_pasien&<?= time() ?>"
                        alt="Captcha">
                  ...
                  <div class="form-group form-verifikasi-captcha">
                    ...
                    <div class="d-flex align-items-center">
                      <img id="captchaAddPenggunaPekerja" class="select-none"
                        data-base="<?= BASE_URL ?>components/features/captcha_generate.php?id=add_user_pekerja"
                        src="<?= BASE_URL ?>components/features/captcha_generate.php?id=add_user_pekerja&<?= time() ?>"
                        alt="Captcha">
                  ...
                  <div class="form-group form-verifikasi-captcha">
                    ...
                    <div class="d-flex align-items-center">
                      <img id="captchaEditPenggunaPekerja" class="select-none"
                        data-base="<?= BASE_URL ?>components/features/captcha_generate.php?id=edit_user_pekerja"
                        src="<?= BASE_URL ?>components/features/captcha_generate.php?id=edit_user_pekerja&<?= time() ?>"
                        alt="Captcha">
                  ...
                  <div class="form-group form-verifikasi-captcha">
                    ...
                    <div class="d-flex align-items-center">
                      <img id="captchaAddPenggunaAdmin" class="select-none"
                        data-base="<?= BASE_URL ?>components/features/captcha_generate.php?id=add_user_admin"
                        src="<?= BASE_URL ?>components/features/captcha_generate.php?id=add_user_admin&<?= time() ?>"
                        alt="Captcha">
                  ...
                  <div class="form-group form-verifikasi-captcha">
                    ...
                    <div class="d-flex align-items-center">
                      <img id="captchaEditPenggunaAdmin" class="select-none"
                        data-base="<?= BASE_URL ?>components/features/captcha_generate.php?id=edit_user_admin"
                        src="<?= BASE_URL ?>components/features/captcha_generate.php?id=edit_user_admin&<?= time() ?>"
                        alt="Captcha">
