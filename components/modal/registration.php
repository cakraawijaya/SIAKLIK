            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group mt-2">
                  ...
                  <input type="email" class="form-control select-none" placeholder="Masukkan email aktif" name="register-email" autocomplete="email" required oninput="filterGmail(this)">
                </div>
              </div>
