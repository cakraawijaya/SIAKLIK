<?php
    ...
    // Ambil data pasien
    $query = mysqli_query($koneksi, "SELECT * FROM akun_pasien") or die(mysqli_error($koneksi));
    ...
    $html .= '<div class="header">
        ...
        <div class="text-group">
            <h1>SIAKLIK</h1>
            <p>Laporan Data Pengguna SIAKLIK Kategori <strong>Pasien</strong></p>
        </div>
    </div>';
    ...
    $dompdf->render();
    $dompdf->stream('data_user_pasien.pdf');
