<?php
    ...
    // Ambil data semua pekerja
    $query = mysqli_query($koneksi, "SELECT * FROM akun_pekerja WHERE role_id = 2") or die(mysqli_error($koneksi));
    ...
    $html .= '<div class="header">
        ...
        <div class="text-group">
            <h1>SIAKLIK</h1>
            <p>Laporan Data Pengguna SIAKLIK Kategori <strong>Pekerja</strong></p>
        </div>
    </div>';
    ...
    $dompdf->render();
    $dompdf->stream('data_user_pekerja.pdf');
