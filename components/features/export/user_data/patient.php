<?php
    ...
    // ===========================================================================================
    // Query ini digunakan untuk mengambil seluruh data user (pasien) dari tabel akun_pekerja
    $query = mysqli_query($koneksi, "
        SELECT * FROM akun_pasien ORDER BY
    ...
    $html .= '<div class="header">
        ...
        <div class="text-group">
            <h1>SIAKLIK</h1>
            <p>Laporan Data User (Pasien) Poliklinik</p>
        </div>
    </div>';
    ...
    // ===========================================================================================
    $count = mysqli_num_rows($query); // Menghitung total jumlah data user (pasien)
    ...
    $html .= '<div class="footer">
        <p class="right">Jumlah data user (Pasien): <b>'.$count.'</b></p>
    ...
    $dompdf->render();
    $dompdf->stream('user_pasien_poliklinik.pdf');
