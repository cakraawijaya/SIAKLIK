<?php
    ...
    // ===========================================================================================
    // Query ini digunakan untuk mengambil seluruh data user (admin) dari tabel akun_pekerja
    $query = mysqli_query($koneksi, "
        SELECT * FROM akun_pekerja WHERE role_id = 1 ORDER BY
    ...
    $html .= '<div class="header">
        ...
        <div class="text-group">
            <h1>SIAKLIK</h1>
            <p>Laporan Data User (Admin) Poliklinik</p>
        </div>
    </div>';
    ...
    // ===========================================================================================
    $count = mysqli_num_rows($query); // Menghitung total jumlah data user (admin)
    ...
    $dompdf->render();
    $dompdf->stream('user_admin_poliklinik.pdf');
