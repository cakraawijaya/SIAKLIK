...
Highcharts.chart('container', {
  ...
  series: [{
    ...
    data: [
      { name: "FTI"     , y: 20  },   // Data Satker FTI
      { name: "FAD"     , y: 7   },   // Data Satker FAD
      { name: "FH"      , y: 24  },   // Data Satker FH
      { name: "FE"      , y: 8   },   // Data Satker FE
      { name: "PASCA"   , y: 1   },   // Data Satker PASCA
      { name: "FISIP"   , y: 19  },   // Data Satker FISIP
      { name: "FIK"     , y: 7   },   // Data Satker FIK
      { name: "FTSP"    , y: 4   },   // Data Satker FTSP
      { name: "FEB"     , y: 9   },   // Data Satker FEB
      { name: "FT"      , y: 11  },   // Data Satker FT
      { name: "Rektorat", y: 112 },   // Data Satker Rektorat
      { name: "Koperasi", y: 3   },   // Data Satker Koperasi
      { name: "FP"      , y: 19  }    // Data Satker FP
    ]
  }],
  ...
  exporting: {
    ...
    tableCaption: 'Kunjungan Pasien Berdasarkan Satker — 2022', // Caption tabel
