...
Highcharts.chart('container', {
  ...
  series: [{
    ...
    data: [
      { name: "FAD"     , y: 2   },   // Data Satker FAD
      { name: "FH"      , y: 5   },   // Data Satker FH
      { name: "PASCA"   , y: 1   },   // Data Satker PASCA
      { name: "FISIP"   , y: 32  },   // Data Satker FISIP
      { name: "FEB"     , y: 54  },   // Data Satker FEB
      { name: "FT"      , y: 36  },   // Data Satker FT
      { name: "Rektorat", y: 12  },   // Data Satker Rektorat
      { name: "Koperasi", y: 1   },   // Data Satker Koperasi
      { name: "FP"      , y: 35  }    // Data Satker FP
    ]
  }],
  ...
  exporting: {
    ...
    tableCaption: 'Kunjungan Pasien Berdasarkan Satker — 2015', // Caption tabel
