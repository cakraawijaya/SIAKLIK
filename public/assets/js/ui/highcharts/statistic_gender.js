...
Highcharts.chart('container', {
        ...
        var watcher = setInterval(function () {
          ...
          if (table) { // Jika tabel sudah ada, maka :
            ...
            if (thead && thead.cells.length >= 2) {
              thead.cells[0].textContent = 'Jenis Kelamin';   // Mengubah header kolom pertama (Jenis Kelamin)
  ...
  /* ============================= DATA SERIES GRAFIK ============================== */
  series: [{
    name: "Pasien",        // Nama series
    colorByPoint: true,    // Warna berbeda tiap bar
    data: [
      { name: "Laki-Laki", y: 3968 },   // Data Jenis Kelamin Laki-Laki
      { name: "Perempuan", y: 2546 }    // Data Jenis Kelamin Perempuan
    ]
  }],
  ...
  exporting: {
    ...
    tableCaption: 'Kunjungan Pasien Berdasarkan Jenis Kelamin', // Caption tabel

    csv: {
      columnHeaderFormatter: function(item) {
        if (!item) return 'Jenis Kelamin';  // Header kolom pertama CSV
