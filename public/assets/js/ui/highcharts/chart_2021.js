...
Highcharts.chart('container', {
  ...
  series: [{
    ...
    data: [
      ...
      { name: "FAD"     , y: 12  },   // Data Satker FAD
      { name: "FH"      , y: 13  },   // Data Satker FH
      { name: "FE"      , y: 1   },   // Data Satker FE
      { name: "PASCA"   , y: 4   },   // Data Satker PASCA
      { name: "FISIP"   , y: 14  },   // Data Satker FISIP
      { name: "FIK"     , y: 12  },   // Data Satker FIK
      { name: "FTSP"    , y: 1   },   // Data Satker FTSP
      { name: "FEB"     , y: 28  },   // Data Satker FEB
      { name: "Anak"    , y: 1   },   // Data Satker Anak
      { name: "FT"      , y: 10  },   // Data Satker FT
      { name: "Rektorat", y: 114 },   // Data Satker Rektorat
      { name: "Koperasi", y: 5   },   // Data Satker Koperasi
      { name: "FP"      , y: 24  }    // Data Satker FP
    ]
  }],
  ...
  exporting: {
    ...
    tableCaption: 'Kunjungan Pasien Berdasarkan Satker — 2021', // Caption tabel
