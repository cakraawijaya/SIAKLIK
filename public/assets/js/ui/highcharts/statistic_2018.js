...
Highcharts.chart('container', {
  ...
  series: [{
    ...
    data: [
      { name: "FAD"     , y: 21  },   // Data Satker FAD
      { name: "FH"      , y: 68  },   // Data Satker FH
      { name: "PASCA"   , y: 4   },   // Data Satker PASCA
      { name: "FISIP"   , y: 73  },   // Data Satker FISIP
      { name: "FIK"     , y: 7   },   // Data Satker FIK
      { name: "FEB"     , y: 80  },   // Data Satker FEB
      { name: "Anak"    , y: 1   },   // Data Satker Anak
      { name: "FT"      , y: 81  },   // Data Satker FT
      { name: "Rektorat", y: 240 },   // Data Satker Rektorat
      { name: "Koperasi", y: 2   },   // Data Satker Koperasi
      { name: "FP"      , y: 77  }    // Data Satker FP
    ]
  }],
  ...
  exporting: {
    ...
    tableCaption: 'Kunjungan Pasien Berdasarkan Satker — 2018', // Caption tabel
