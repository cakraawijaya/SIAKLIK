...
Highcharts.chart('container', {
  ...
  series: [{
    ...
    data: [
      { name: "FAD"     , y: 152 },   // Data Satker FAD
      { name: "FH"      , y: 72  },   // Data Satker FH
      { name: "PASCA"   , y: 22  },   // Data Satker PASCA
      { name: "FISIP"   , y: 252 },   // Data Satker FISIP
      { name: "FIK"     , y: 3   },   // Data Satker FIK
      { name: "FEB"     , y: 402 },   // Data Satker FEB
      { name: "FT"      , y: 304 },   // Data Satker FT
      { name: "Rektorat", y: 761 },   // Data Satker Rektorat
      { name: "Koperasi", y: 30  },   // Data Satker Koperasi
      { name: "FP"      , y: 317 }    // Data Satker FP
    ]
  }],
  ...
  exporting: {
    ...
    tableCaption: 'Kunjungan Pasien Berdasarkan Satker — 2013', // Caption tabel
