...
Highcharts.chart('container', {
  ...
  series: [{
    ...
    data: [
      { name: "FAD"     , y: 20  },   // Data Satker FAD
      { name: "FH"      , y: 10  },   // Data Satker FH
      { name: "PASCA"   , y: 4   },   // Data Satker PASCA
      { name: "FISIP"   , y: 74  },   // Data Satker FISIP
      { name: "FEB"     , y: 112 },   // Data Satker FEB
      { name: "FT"      , y: 85  },   // Data Satker FT
      { name: "Rektorat", y: 96  },   // Data Satker Rektorat
      { name: "Koperasi", y: 3   },   // Data Satker Koperasi
      { name: "FP"      , y: 76  }    // Data Satker FP
    ]
  }],
  ...
  exporting: {
    ...
    tableCaption: 'Kunjungan Pasien Berdasarkan Satker — 2014', // Caption tabel
