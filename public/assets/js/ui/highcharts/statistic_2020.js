...
Highcharts.chart('container', {
  ...
  series: [{
    ...
    data: [
      { name: "FTI"     , y: 3   },   // Data Satker FTI
      { name: "FAD"     , y: 8   },   // Data Satker FAD
      { name: "FH"      , y: 25  },   // Data Satker FH
      { name: "PASCA"   , y: 4   },   // Data Satker PASCA
      { name: "FISIP"   , y: 33  },   // Data Satker FISIP
      { name: "Idem"    , y: 1   },   // Data Satker Idem
      { name: "FIK"     , y: 13  },   // Data Satker FIK
      { name: "FTSP"    , y: 2   },   // Data Satker FTSP
      { name: "FEB"     , y: 19  },   // Data Satker FEB
      { name: "FT"      , y: 23  },   // Data Satker FT
      { name: "Rektorat", y: 154 },   // Data Satker Rektorat
      { name: "Koperasi", y: 7   },   // Data Satker Koperasi
      { name: "FP"      , y: 12  }    // Data Satker FP
    ]
  }],
  ...
  exporting: {
    ...
    tableCaption: 'Kunjungan Pasien Berdasarkan Satker — 2020', // Caption tabel
